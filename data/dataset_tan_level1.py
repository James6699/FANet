...
class SOD360Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # tan_imgs,_,_=self.erp2ico_image(equi_img,64,padding_size,True)
        ...
        # tan_20 = self.normalization(Image.fromarray(np.uint8(output_tandic_[20]* 255.0)))
        # tan_21 = self.normalization(Image.fromarray(np.uint8(output_tandic_[21]* 255.0)))
        # tan_22 = self.normalization(Image.fromarray(np.uint8(output_tandic_[22]* 255.0)))
        # tan_23 = self.normalization(Image.fromarray(np.uint8(output_tandic_[23]* 255.0)))
        # tan_24 = self.normalization(Image.fromarray(np.uint8(output_tandic_[24]* 255.0)))
        # tan_25 = self.normalization(Image.fromarray(np.uint8(output_tandic_[25]* 255.0)))
        # tan_26 = self.normalization(Image.fromarray(np.uint8(output_tandic_[26]* 255.0)))
        # tan_27 = self.normalization(Image.fromarray(np.uint8(output_tandic_[27]* 255.0)))
        # tan_28 = self.normalization(Image.fromarray(np.uint8(output_tandic_[28]* 255.0)))
        # tan_29 = self.normalization(Image.fromarray(np.uint8(output_tandic_[29]* 255.0)))
        # tan_30 = self.normalization(Image.fromarray(np.uint8(output_tandic_[30]* 255.0)))
        # tan_31 = self.normalization(Image.fromarray(np.uint8(output_tandic_[31]* 255.0)))
        # tan_32 = self.normalization(Image.fromarray(np.uint8(output_tandic_[32]* 255.0)))
        # tan_33 = self.normalization(Image.fromarray(np.uint8(output_tandic_[33]* 255.0)))
        # tan_34 = self.normalization(Image.fromarray(np.uint8(output_tandic_[34]* 255.0)))
        # tan_35 = self.normalization(Image.fromarray(np.uint8(output_tandic_[35]* 255.0)))
        # tan_36 = self.normalization(Image.fromarray(np.uint8(output_tandic_[36]* 255.0)))
        # tan_37 = self.normalization(Image.fromarray(np.uint8(output_tandic_[37]* 255.0)))
        # tan_38 = self.normalization(Image.fromarray(np.uint8(output_tandic_[38]* 255.0)))
        # tan_39 = self.normalization(Image.fromarray(np.uint8(output_tandic_[39]* 255.0)))
        # tan_40 = self.normalization(Image.fromarray(np.uint8(output_tandic_[40]* 255.0)))
        # tan_41 = self.normalization(Image.fromarray(np.uint8(output_tandic_[41]* 255.0)))
        # tan_42 = self.normalization(Image.fromarray(np.uint8(output_tandic_[42]* 255.0)))
        # tan_43 = self.normalization(Image.fromarray(np.uint8(output_tandic_[43]* 255.0)))
        # tan_44 = self.normalization(Image.fromarray(np.uint8(output_tandic_[44]* 255.0)))
        # tan_45 = self.normalization(Image.fromarray(np.uint8(output_tandic_[45]* 255.0)))
        # tan_46 = self.normalization(Image.fromarray(np.uint8(output_tandic_[46]* 255.0)))
        # tan_47 = self.normalization(Image.fromarray(np.uint8(output_tandic_[47]* 255.0)))
        # tan_48 = self.normalization(Image.fromarray(np.uint8(output_tandic_[48]* 255.0)))
        # tan_49 = self.normalization(Image.fromarray(np.uint8(output_tandic_[49]* 255.0)))
        # tan_50 = self.normalization(Image.fromarray(np.uint8(output_tandic_[50]* 255.0)))
        # tan_51 = self.normalization(Image.fromarray(np.uint8(output_tandic_[51]* 255.0)))
        # tan_52 = self.normalization(Image.fromarray(np.uint8(output_tandic_[52]* 255.0)))
        # tan_53 = self.normalization(Image.fromarray(np.uint8(output_tandic_[53]* 255.0)))
        # tan_54 = self.normalization(Image.fromarray(np.uint8(output_tandic_[54]* 255.0)))
        # tan_55 = self.normalization(Image.fromarray(np.uint8(output_tandic_[55]* 255.0)))
        # tan_56 = self.normalization(Image.fromarray(np.uint8(output_tandic_[56]* 255.0)))
        # tan_57 = self.normalization(Image.fromarray(np.uint8(output_tandic_[57]* 255.0)))
        # tan_58 = self.normalization(Image.fromarray(np.uint8(output_tandic_[58]* 255.0)))
        # tan_59 = self.normalization(Image.fromarray(np.uint8(output_tandic_[59]* 255.0)))
        # tan_60 = self.normalization(Image.fromarray(np.uint8(output_tandic_[60]* 255.0)))
        # tan_61 = self.normalization(Image.fromarray(np.uint8(output_tandic_[61]* 255.0)))
        # tan_62 = self.normalization(Image.fromarray(np.uint8(output_tandic_[62]* 255.0)))
        # tan_63 = self.normalization(Image.fromarray(np.uint8(output_tandic_[63]* 255.0)))
        # tan_64 = self.normalization(Image.fromarray(np.uint8(output_tandic_[64]* 255.0)))
        # tan_65 = self.normalization(Image.fromarray(np.uint8(output_tandic_[65]* 255.0)))
        # tan_66 = self.normalization(Image.fromarray(np.uint8(output_tandic_[66]* 255.0)))
        # tan_67 = self.normalization(Image.fromarray(np.uint8(output_tandic_[67]* 255.0)))
        # tan_68 = self.normalization(Image.fromarray(np.uint8(output_tandic_[68]* 255.0)))
        # tan_69 = self.normalization(Image.fromarray(np.uint8(output_tandic_[69]* 255.0)))
        # tan_70 = self.normalization(Image.fromarray(np.uint8(output_tandic_[70]* 255.0)))
        # tan_71 = self.normalization(Image.fromarray(np.uint8(output_tandic_[71]* 255.0)))
        # tan_72 = self.normalization(Image.fromarray(np.uint8(output_tandic_[72]* 255.0)))
        # tan_73 = self.normalization(Image.fromarray(np.uint8(output_tandic_[73]* 255.0)))
        # tan_74 = self.normalization(Image.fromarray(np.uint8(output_tandic_[74]* 255.0)))
        # tan_75 = self.normalization(Image.fromarray(np.uint8(output_tandic_[75]* 255.0)))
        # tan_76 = self.normalization(Image.fromarray(np.uint8(output_tandic_[76]* 255.0)))
        # tan_77 = self.normalization(Image.fromarray(np.uint8(output_tandic_[77]* 255.0)))
        # tan_78 = self.normalization(Image.fromarray(np.uint8(output_tandic_[78]* 255.0)))
        # tan_79 = self.normalization(Image.fromarray(np.uint8(output_tandic_[79]* 255.0)))
