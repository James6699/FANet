...
class SOD360Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in range(output_tandic.shape[1]):
            ...
            output_tandic_no_tangent[i] = np.ones_like( output_tandic_[i] )
        ...
        tan_0 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[0]* 255.0)))
        tan_1 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[1]* 255.0)))
        tan_2 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[2]* 255.0)))
        tan_3 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[3]* 255.0)))
        tan_4 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[4]* 255.0)))
        tan_5 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[5]* 255.0)))
        tan_6 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[6]* 255.0)))
        tan_7 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[7]* 255.0)))
        tan_8 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[8]* 255.0)))
        tan_9 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[9]* 255.0)))
        tan_10 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[10]* 255.0)))
        tan_11 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[11]* 255.0)))
        tan_12 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[12]* 255.0)))
        tan_13 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[13]* 255.0)))
        tan_14 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[14]* 255.0)))
        tan_15 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[15]* 255.0)))
        tan_16 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[16]* 255.0)))
        tan_17 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[17]* 255.0)))
        tan_18 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[18]* 255.0)))
        tan_19 = self.normalization(Image.fromarray(np.uint8(output_tandic_no_tangent[19]* 255.0)))
