...
class FANet(nn.Module):
    ...
    def forward(self, x):
        ...
        tan0_FPN_feature_list = self.FPN([tanfeatures_0[0],tanfeatures_0[1],tanfeatures_0[2],tanfeatures_0[3]])
        tan1_FPN_feature_list = self.FPN([tanfeatures_1[0],tanfeatures_1[1],tanfeatures_1[2],tanfeatures_1[3]])
        tan2_FPN_feature_list = self.FPN([tanfeatures_2[0],tanfeatures_2[1],tanfeatures_2[2],tanfeatures_2[3]])
        tan3_FPN_feature_list = self.FPN([tanfeatures_3[0],tanfeatures_3[1],tanfeatures_3[2],tanfeatures_3[3]])
        tan4_FPN_feature_list = self.FPN([tanfeatures_4[0],tanfeatures_4[1],tanfeatures_4[2],tanfeatures_4[3]])
        tan5_FPN_feature_list = self.FPN([tanfeatures_5[0],tanfeatures_5[1],tanfeatures_5[2],tanfeatures_5[3]])
        tan6_FPN_feature_list = self.FPN([tanfeatures_6[0],tanfeatures_6[1],tanfeatures_6[2],tanfeatures_6[3]])
        tan7_FPN_feature_list = self.FPN([tanfeatures_7[0],tanfeatures_7[1],tanfeatures_7[2],tanfeatures_7[3]])
        tan8_FPN_feature_list = self.FPN([tanfeatures_8[0],tanfeatures_8[1],tanfeatures_8[2],tanfeatures_8[3]])
        tan9_FPN_feature_list = self.FPN([tanfeatures_9[0],tanfeatures_9[1],tanfeatures_9[2],tanfeatures_9[3]])
        tan10_FPN_feature_list = self.FPN([tanfeatures_10[0],tanfeatures_10[1],tanfeatures_10[2],tanfeatures_10[3]])
        tan11_FPN_feature_list = self.FPN([tanfeatures_11[0],tanfeatures_11[1],tanfeatures_11[2],tanfeatures_11[3]])
        tan12_FPN_feature_list = self.FPN([tanfeatures_12[0],tanfeatures_12[1],tanfeatures_12[2],tanfeatures_12[3]])
        tan13_FPN_feature_list = self.FPN([tanfeatures_13[0],tanfeatures_13[1],tanfeatures_13[2],tanfeatures_13[3]])
        tan14_FPN_feature_list = self.FPN([tanfeatures_14[0],tanfeatures_14[1],tanfeatures_14[2],tanfeatures_14[3]])
        tan15_FPN_feature_list = self.FPN([tanfeatures_15[0],tanfeatures_15[1],tanfeatures_15[2],tanfeatures_15[3]])
        tan16_FPN_feature_list = self.FPN([tanfeatures_16[0],tanfeatures_16[1],tanfeatures_16[2],tanfeatures_16[3]])
        tan17_FPN_feature_list = self.FPN([tanfeatures_17[0],tanfeatures_17[1],tanfeatures_17[2],tanfeatures_17[3]])
        tan18_FPN_feature_list = self.FPN([tanfeatures_18[0],tanfeatures_18[1],tanfeatures_18[2],tanfeatures_18[3]])
        tan19_FPN_feature_list = self.FPN([tanfeatures_19[0],tanfeatures_19[1],tanfeatures_19[2],tanfeatures_19[3]])
