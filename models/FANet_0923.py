...
class PFA(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.Conv1x1(self.feature_selection(torch.cat((equi_feature_, proj_feature), dim=1)))
...
class MLFA(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv1X1 = nn.Sequential(nn.Conv2d(in_channel, out_channel, kernel_size=1, bias=False),
                                                nn.BatchNorm2d(out_channel))
