...
class FANet(nn.Module):
    ...
    def forward(self, x):
        ...
        tan1_FPN_feature_list = self.FPN([tanfeatures_1[0],tanfeatures_1[1],tanfeatures_0[2]])
        tan2_FPN_feature_list = self.FPN([tanfeatures_2[0],tanfeatures_2[1],tanfeatures_0[2]])
        tan3_FPN_feature_list = self.FPN([tanfeatures_3[0],tanfeatures_3[1],tanfeatures_0[2]])
        tan4_FPN_feature_list = self.FPN([tanfeatures_4[0],tanfeatures_4[1],tanfeatures_0[2]])
        tan5_FPN_feature_list = self.FPN([tanfeatures_5[0],tanfeatures_5[1],tanfeatures_0[2]])
        tan6_FPN_feature_list = self.FPN([tanfeatures_6[0],tanfeatures_6[1],tanfeatures_0[2]])
        tan7_FPN_feature_list = self.FPN([tanfeatures_7[0],tanfeatures_7[1],tanfeatures_0[2]])
        tan8_FPN_feature_list = self.FPN([tanfeatures_8[0],tanfeatures_8[1],tanfeatures_0[2]])
        tan9_FPN_feature_list = self.FPN([tanfeatures_9[0],tanfeatures_9[1],tanfeatures_0[2]])
        tan10_FPN_feature_list = self.FPN([tanfeatures_10[0],tanfeatures_10[1],tanfeatures_0[2]])
        tan11_FPN_feature_list = self.FPN([tanfeatures_11[0],tanfeatures_11[1],tanfeatures_0[2]])
        tan12_FPN_feature_list = self.FPN([tanfeatures_12[0],tanfeatures_12[1],tanfeatures_0[2]])
        tan13_FPN_feature_list = self.FPN([tanfeatures_13[0],tanfeatures_13[1],tanfeatures_0[2]])
        tan14_FPN_feature_list = self.FPN([tanfeatures_14[0],tanfeatures_14[1],tanfeatures_0[2]])
        tan15_FPN_feature_list = self.FPN([tanfeatures_15[0],tanfeatures_15[1],tanfeatures_0[2]])
        tan16_FPN_feature_list = self.FPN([tanfeatures_16[0],tanfeatures_16[1],tanfeatures_0[2]])
        tan17_FPN_feature_list = self.FPN([tanfeatures_17[0],tanfeatures_17[1],tanfeatures_0[2]])
        tan18_FPN_feature_list = self.FPN([tanfeatures_18[0],tanfeatures_18[1],tanfeatures_0[2]])
        tan19_FPN_feature_list = self.FPN([tanfeatures_19[0],tanfeatures_19[1],tanfeatures_0[2]])
