...
class FPNFusion(nn.Module):
    def __init__(self, inchannel):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(inchannel, inchannel, kernel_size=3, stride=1, padding=1),
...
class MLFA(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.selectattention = nn.Sequential(nn.Conv2d(8, 4, kernel_size=1, bias=False),
                                             nn.BatchNorm2d(4),
                                             nn.Softmax(dim=1),
                                             )
